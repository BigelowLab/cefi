...
### Hindcast
```{r}
uri = catalog_uri(region = "Northwest Atlantic", xcast = "hindcast")
...
```{r}
uri = catalog_uri(region = "Northwest Atlantic", period = "seasonal_reforecast")
...
```{r}
uri = catalog_uri(region = "Northwest Atlantic", period = "seasonal_forecast")
